...
export class CuestionarioComponent implements OnInit {
  ...
  socMedra: string[] = ["TRASTORNOS CARDIACOS", "TRASTORNOS SANGUINEOS Y DEL SISTEMA LINFATICO"];
  ...
  ngOnInit() {
    if (this.tokenService.getToken()) {
      ...
      this.cargarMedra("TRASTORNOS CARDIACOS");
    }
  }
  ...
  agregarMedra(medra: string): boolean {
    console.log(medra);
    if (medra != null && medra != "") {
      // si el padecimiento ya esta en la lista no lo ingresa
